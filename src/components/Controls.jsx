...
const Controls = ({ onAddSquare, onClearSquares, onReload }) => {
  return (
    <div className="mt-8 mb-12 flex flex-wrap gap-4 justify-center">
      ...
      <button 
        className="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none transition-colors duration-150"
        onClick={onAddSquare}
      >
        Add New Square
      </button>
      ...
      <button 
        className="text-white bg-red-700 hover:bg-red-800 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none transition-colors duration-150"
